...
UUID='e85594e4-154f-4b8c-8c1e-391a618b278a'
VMESS_WSPATH='/vmess'
VLESS_WSPATH='/vless'
...
curl -L https://raw.githubusercontent.com/naiba/nezha/master/script/install.sh -o nezha.sh && chmod +x nezha.sh && ./nezha.sh install_agent nezha.lfff.top 443 9KsrWwDYKXCfPgID7V --tls
